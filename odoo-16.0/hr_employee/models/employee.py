...
class Employee(models.Model):
    ...
    def _check_skills_limits(self, certification_ids):
        ...
        if not certification_ids or not isinstance(certification_ids[0], tuple) or len(certification_ids[0]) < 3:
            raise UserError("Certification IDs format is invalid or not properly defined.")
